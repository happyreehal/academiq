    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#030810", overflowX: "hidden", cursor: "none" }}>
      <style>{`
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        /* Scroll animations */
        .fade-up { opacity: 0; transform: translateY(60px); transition: all 0.9s cubic-bezier(0.16,1,0.3,1); }
        .fade-up.visible { opacity: 1; transform: translateY(0); }
        .fade-left { opacity: 0; transform: translateX(-60px); transition: all 0.9s cubic-bezier(0.16,1,0.3,1); }
        .fade-left.visible { opacity: 1; transform: translateX(0); }
        .fade-right { opacity: 0; transform: translateX(60px); transition: all 0.9s cubic-bezier(0.16,1,0.3,1); }
        ...
        .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 20px 40px rgba(29,158,117,0.3); }
        ...
        .btn-outline:hover { border-color: #1D9E75; color: #1D9E75; transform: translateY(-2px); }
        ...
        .feat-card:hover { background: rgba(29,158,117,0.04); border-color: rgba(29,158,117,0.2); transform: translateY(-4px); }
        ...
        .stat-num {
          ...
          font-size: 56px; font-weight: 300; color: #1D9E75;
          line-height: 1;
        }

        /* Divider line */
        .divider {
          width: 60px; height: 1px; background: #1D9E75; margin: 20px 0;
        }
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
          <img src={COLLEGE_LOGO} alt="logo" style={{ width: "38px", height: "38px", borderRadius: "4px", objectFit: "cover" }} />
          <div>
        ...
        <button className="btn-primary" onClick={() => navigate("/login")} style={{ padding: "10px 24px", fontSize: "11px" }}>
          <span>Login →</span>
        </button>
      </nav>
      ...
      <section style={{
        ...
        <div className="hero-grid" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 6%", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center", width: "100%", position: "relative", zIndex: 1 }}>
          <div style={{ opacity: isLoaded ? 1 : 0, transform: isLoaded ? "translateY(0)" : "translateY(40px)", transition: "all 1s cubic-bezier(0.16,1,0.3,1)" }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", marginBottom: "28px", padding: "6px 16px", border: "1px solid rgba(29,158,117,0.3)", borderRadius: "2px" }}>
            ...
            <h1 style={{
              ...
              Your Academic<br />
              Edge,{" "}
              <span style={{ fontStyle: "italic", color: "#1D9E75" }}>Powered</span><br />
              by AI
            </h1>
            ...
            <div className="cta-btns" style={{ display: "flex", gap: "16px", flexWrap: "wrap", marginBottom: "60px" }}>
              <button className="btn-primary" onClick={() => navigate("/register")}><span>Get Started Free</span></button>
          ...
          {/* Hero Visual */}
          <div className="hero-visual" style={{ display: "flex", justifyContent: "center", alignItems: "center", opacity: isLoaded ? 1 : 0, transition: "opacity 1.2s ease 0.3s" }}>
            <div style={{ position: "relative", width: "360px", height: "360px" }}>
              ...
              <div style={{
                ...
                border: "1px dashed rgba(29,158,117,0.08)",
                borderRadius: "50%",
              ...
              <div style={{
                ...
                overflow: "hidden", border: "1px solid rgba(29,158,117,0.2)",
                boxShadow: "0 0 80px rgba(29,158,117,0.1), inset 0 0 80px rgba(0,0,0,0.5)"
              }}>
              ...
              <div style={{
                ...
                boxShadow: "0 20px 40px rgba(29,158,117,0.3)"
              }}>
      ...
      <section id="features" style={{ padding: "120px 6%", background: "#040b14", position: "relative" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div id="feat-title" data-animate style={{ marginBottom: "80px" }}
            className={`fade-up ${isVisible("feat-title") ? "visible" : ""}`}>
          ...
          <div className="feat-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1px", background: "rgba(255,255,255,0.04)" }}>
            {[
              ...
              <div key={i} className="feat-card" style={{ background: "#040b14", animationDelay: `${i * 0.1}s` }}>
          ...
          <div id="about-text" data-animate className={`fade-left ${isVisible("about-text") ? "visible" : ""}`}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginBottom: "40px" }}>
              {[{ icon: "🏆", label: "NAAC Grade A++" }, { icon: "🎓", label: "Autonomous Body" }, { icon: "📍", label: "Sri Anandpur Sahib" }, { icon: "🌐", label: "sgtbcollege.org.in" }].map((item, i) => (
                <div key={i} style={{ padding: "14px 16px", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "2px", display: "flex", alignItems: "center", gap: "10px" }}>
                  <span style={{ fontSize: "16px" }}>{item.icon}</span>
                  <span style={{ fontSize: "12px", color: "rgba(255,255,255,0.5)", letterSpacing: "0.5px" }}>{item.label}</span>
                </div>
              ))}
            </div>
            <a href="https://www.sgtbcollege.org.in/" target="_blank" rel="noreferrer" className="btn-outline" style={{ display: "inline-block", textDecoration: "none", padding: "12px 28px", fontSize: "11px" }}>
              Visit Website →
            </a>
          </div>

          <div className="about-visual" id="about-visual" data-animate style={{ display: "flex", justifyContent: "center" }}
            className={`about-visual fade-right ${isVisible("about-visual") ? "visible" : ""}`}>
            <div style={{ position: "relative", width: "320px", height: "400px" }}>
              <div style={{ width: "100%", height: "100%", border: "1px solid rgba(29,158,117,0.2)", borderRadius: "2px", overflow: "hidden", background: "linear-gradient(135deg, #0d2035, #1D9E75)" }}>
                <img src={COLLEGE_LOGO} alt="College" style={{ width: "100%", height: "100%", objectFit: "contain", padding: "40px" }} />
              </div>
              <div style={{ position: "absolute", top: "-16px", left: "-16px", width: "80px", height: "80px", border: "1px solid rgba(29,158,117,0.3)", borderRadius: "2px" }} />
              <div style={{ position: "absolute", bottom: "-16px", right: "-16px", width: "120px", height: "60px", background: "#1D9E75", borderRadius: "2px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
      ...
      <section style={{ padding: "120px 6%", background: "#040b14", position: "relative" }}>
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div id="steps-title" data-animate style={{ textAlign: "center", marginBottom: "80px" }}
            className={`fade-up ${isVisible("steps-title") ? "visible" : ""}`}>
          ...
          <div className="steps-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "2px", background: "rgba(255,255,255,0.04)" }}>
            {[
              ...
              <div key={i} style={{ background: "#040b14", padding: "48px 36px", position: "relative", overflow: "hidden", borderTop: "2px solid transparent", transition: "border-color 0.3s" }}
                onMouseEnter={e => e.currentTarget.style.borderTopColor = "#1D9E75"}
      ...
      <section id="developer" style={{ padding: "120px 6%", background: "#030810", position: "relative" }}>
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          <div id="dev-title" data-animate style={{ marginBottom: "60px" }}
            className={`fade-up ${isVisible("dev-title") ? "visible" : ""}`}>
          ...
          <div className="dev-card" id="dev-card" data-animate style={{ border: "1px solid rgba(255,255,255,0.06)", padding: "60px", position: "relative", overflow: "hidden" }}
            className={`dev-card fade-up ${isVisible("dev-card") ? "visible" : ""}`}>
            <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "2px", background: "linear-gradient(90deg, #1D9E75, transparent)" }} />
            <div style={{ position: "absolute", top: "-100px", right: "-100px", width: "300px", height: "300px", background: "radial-gradient(circle, rgba(29,158,117,0.04) 0%, transparent 70%)", borderRadius: "50%" }} />

            <div className="dev-inner" style={{ display: "flex", gap: "48px", alignItems: "center", position: "relative" }}>
              <div style={{ flexShrink: 0 }}>
                <div style={{ position: "relative", width: "140px", height: "140px" }}>
                  <img src={MY_PHOTO} alt="Happy Reehal" style={{ width: "100%", height: "100%", borderRadius: "2px", objectFit: "cover", filter: "grayscale(20%)" }} />
                  <div style={{ position: "absolute", bottom: "-8px", right: "-8px", width: "28px", height: "28px", background: "#1D9E75", borderRadius: "2px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "14px" }}>✓</div>
                </div>
              </div>
              <div>
                ...
                <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
                  <a href="https://github.com/happyreehal" target="_blank" rel="noreferrer" className="btn-outline" style={{ textDecoration: "none", padding: "10px 20px", fontSize: "11px" }}>GitHub</a>
                  <a href="https://www.linkedin.com/in/happy-reehal-7225a4315" target="_blank" rel="noreferrer" className="btn-primary" style={{ textDecoration: "none", padding: "10px 20px", fontSize: "11px" }}>
                    <span>LinkedIn</span>
                  </a>
                </div>
              </div>
      ...
      <section style={{ padding: "120px 6%", background: "#040b14", position: "relative", textAlign: "center" }}>
        <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "1px", background: "linear-gradient(90deg, transparent, rgba(29,158,117,0.3), transparent)" }} />
        <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse at center, rgba(29,158,117,0.04) 0%, transparent 70%)" }} />
        <div style={{ maxWidth: "600px", margin: "0 auto", position: "relative" }}>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(32px,5vw,64px)", fontWeight: "300", color: "white", marginBottom: "24px", lineHeight: "1.1" }}>
            Ready to Ace<br /><span style={{ fontStyle: "italic", color: "#1D9E75" }}>Your Exams?</span>
          </h2>
          ...
          <div className="cta-btns" style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap" }}>
            <button className="btn-primary" onClick={() => navigate("/register")}><span>Register Now — It's Free</span></button>
            <button className="btn-outline" onClick={() => navigate("/login")}>Sign In →</button>
          </div>
        </div>
      </section>
