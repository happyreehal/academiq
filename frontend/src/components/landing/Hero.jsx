...
const containerVariants = {
  ...
  visible: {
    opacity: 1,
    transition: {
      staggerChildren: 0.08,    // Each letter delay
...
export default function Hero({ isLoaded, mousePos }) {
  ...
  <CountUp value={s.num} suffix={s.num.includes("+") ? "+" : ""} />
          ...
          <div style={{ position: "relative", width: "360px", height: "360px" }}>
            ...
            >
              <img 
                ...
                style={{ 
                  ...
                  objectFit: "cover", filter: "brightness(0.9)" 
                }} 
              />
            </motion.div>
            ...
            <motion.div 
              ...
              style={{
                ...
                borderRadius: "2px",
                boxShadow: "0 20px 40px rgba(29,158,117,0.5)",
                cursor: "pointer",
              }} 
            >
              <div style={{ 
              ...
              <div style={{ fontSize: "10px", letterSpacing: "1px", opacity: 0.8 }}>
                NAAC GRADE
              </div>
            </motion.div>
          </div>
      ...
      >
        <div style={{ 
          fontSize: "10px", color: "rgba(255,255,255,0.25)", letterSpacing: "2px" 
        }}>
          SCROLL
        </div>
        <motion.div 
