      ...
      <div className="about-grid" style={{ 
        ...
        >
          ...
          <motion.p 
            ...
            style={{ color: "rgba(255,255,255,0.4)", fontSize: "14px", lineHeight: "1.9", marginBottom: "16px", fontWeight: "300" }}
          >
          ...
          <motion.p 
            ...
            style={{ color: "rgba(255,255,255,0.4)", fontSize: "14px", lineHeight: "1.9", marginBottom: "40px", fontWeight: "300" }}
          >
          ...
          <div style={{ position: "relative", width: "320px", height: "400px" }}>
            <motion.div 
              ...
              style={{ 
                ...
                border: "1px solid rgba(29,158,117,0.4)", borderRadius: "2px", 
                overflow: "hidden", background: "linear-gradient(135deg, #0d2035, #1D9E75)", 
            ...
            <motion.div 
              ...
              style={{ position: "absolute", top: "-16px", left: "-16px", width: "80px", height: "80px", border: "1px solid rgba(29,158,117,0.5)", borderRadius: "2px" }} 
            />
            ...
            <motion.div 
              ...
              style={{ 
                ...
                width: "120px", height: "60px", background: "#1D9E75", borderRadius: "2px", 
                display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", 
                boxShadow: "0 10px 20px rgba(29,158,117,0.4)", cursor: "pointer",
              }}
            >
