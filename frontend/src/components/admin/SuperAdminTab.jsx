  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      <div className="card" style={{ 
        ...
        <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "13px", margin: "0 0 28px", fontWeight: "300" }}>
        ...
        <div style={{ 
          ...
          borderRadius: "4px", padding: "20px", marginBottom: "28px" 
        }}>
          <div style={{ 
            fontSize: "11px", fontWeight: "600", color: "rgba(167,139,250,0.8)", 
            marginBottom: "8px", letterSpacing: "1px", textTransform: "uppercase" 
          }}>
            Current Secret Key:
          </div>
          <div style={{ fontFamily: "monospace", fontSize: "18px", color: "white", letterSpacing: "2px" }}>
          ...
          <div>
            ...
            {newSecret.length > 0 && newSecret.length < 8 && (
              <p style={{ color: "#EF4444", fontSize: "11px", marginTop: "6px" }}>
                {8 - newSecret.length} more characters needed
              </p>
            )}
          </div>

          {/* ✅ Fix 1 — disabled when too short */}
          <button 
            className="btn-purple" 
            onClick={handleUpdate}
            disabled={newSecret.length < 8}
      ...
      {/* Warning Box */}
      <div style={{ 
        background: "rgba(239,68,68,0.05)", borderRadius: "4px", 
        border: "1px solid rgba(239,68,68,0.2)", padding: "24px" 
      }}>
        <h3 style={{ 
          color: "#EF4444", fontSize: "14px", fontWeight: "600", 
          margin: "0 0 10px", letterSpacing: "1px", textTransform: "uppercase" 
        }}>
          ⚠️ Important
        </h3>
        <p style={{ 
